...
let cardsData = [
  ...
  class Player {
	constructor(obj){
	  this.cardsData = obj.cardsData // temporary, delete when testing is complete
	  this.name = obj.name
	  ...
	  this.deck = obj.deck || [burn, burn, burn, burn, fb, fb, fb, burn, fb, fb, fb, fb] // retrieving from db, will be filled once player chooses Archetype
